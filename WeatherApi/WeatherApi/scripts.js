...
<div class="weather-container-card__description">${weather.description}<img id="img" src="http://openweathermap.org/img/wn/${weather.icon}@2x.png"></div>
<div class="weather-container-card__humidity"><span class="humidity_span">Humidity</span> <span class="humidity_span">${element.main.humidity}%</span></div>
